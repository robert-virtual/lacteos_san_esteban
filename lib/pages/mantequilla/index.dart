...
class Mantequilla extends GetView<UserController> {
  ...
  Mantequilla({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Mantequilla"),
      ...
      body: FutureBuilder<List<List>>(
          future: controller.getSheet("Mantequilla!A:H"),
          builder: (ctx, snap) {
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 10.0),
                                Text(
                                  "Mantequilla crema: ${item[6]} libras",
                                  textAlign: TextAlign.left,
                                  style: textGray,
                                ),
                                const SizedBox(height: 10.0),
                                Text(
                                  "Crema industrial: ${item[7]} Libras",
                                  textAlign: TextAlign.left,
                                  style: textGray,
                                ),
                                const SizedBox(height: 10.0),
